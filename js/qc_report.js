...
$('#search_go').click(function () {
	...
	if (report_type == 0) {
		...
		var exp_fn_sr = project + "-" + report_name + "-检索结果";
		drawDataTable('#dt_searchresults', exp_fn_sr, {
		...
		switch (report_type) {
			case 'sequencing_data':
				...
				if (typeof loadReport_QC_SeqData == "undefined") {
					loadScript("./js/qc_report_seqdata.js");
					$("#sample_comparision button").attr("onClick","compareSap_QC_SeqData();");
				}
				break;
		}
